  ...
  public Behavior initialBehavior(Optional<WalletState> snapshotState) {
    ...
    b.setEventHandler(WalletEvent.CurrencySent.class,
            evt -> {
                ...
                //TODO Update State to reflect money leaving the wallet
     ...
     */
    b.setReadOnlyCommandHandler(CheckBalance.class,
        // Get the balance from the current state and reply with that message.
        (cmd, ctx) -> ctx.reply("wallet state is: "+ state().toString()));
